...
![pikachu-running](https://tenor.com/5GBz.gif)
...
Run the ```bash npm install``` command to install all the node packages and then you can run the project using ```bash npm run dev```